...
if is_available "smart-splits.nvim" then
  ...
  maps.n["<Enter><Enter>"] = { "<C-w>w", desc = "Move to next split" }
  maps.n["ss"] = { "<C-w>s", desc = "split to below split" }
  maps.n["sv"] = { "<C-w>v", desc = "split to above split" }
  maps.n["sh"] = { "<C-w>h", desc = "Move to above split" }
  maps.n["sl"] = { "<C-w>l", desc = "Move to above split" }
  -- Resize with arrows
